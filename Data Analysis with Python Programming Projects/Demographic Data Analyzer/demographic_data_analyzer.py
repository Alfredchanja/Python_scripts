...
def calculate_demographic_data(print_data = True):
  ...
  rich_percentage = (df[['hours-per-week', 'salary']][(df['hours-per-week'] == min_work_hours) & (df['salary'] == '>50K')]['salary'].count() * 100 / num_min_workers).round(1)
  ...
  top_IN_occupation = (df[['native-country', 'occupation']][df['native-country'] == 'India']['occupation'].value_counts()).idxmax()
